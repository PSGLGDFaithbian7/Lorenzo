//==============================================================================
// tb_lte_task_context.sv - B2 task context latch directed test
//==============================================================================
`timescale 1ns/1ps
import lte_pkg::*;
...
module tb_lte_task_context;
  ...
  lte_task_context dut (
    ...
    .last_head_count_i        (last_head_count_i),
  ...
  initial begin
    ...
    chk_int("active_sa_cnt",  ctx_o.active_sa_count,        2);
    chk_int("last_head_count", ctx_o.last_head_count,       2);
    ...
    chk1("flag_in_lz_fo",     flag_in_lz_fo,                1'b0);
    ...
    flags_i = 8'b0000_1010;
    pe_desc_i = {96'h0, 8'd32, 8'd32, 8'd32, 8'd32};
    task_launch = 1; clk_tick(1); task_launch = 0;
    clk_tick(1);
    ...
    chk1("flag_in_lz_off", flag_in_lz_o,         1'b0);
    chk1("flag_in_fo_on",  flag_in_lz_fo,        1'b1);
    chk1("flag_out_fo",    flag_out_lz_fo,       1'b1);
